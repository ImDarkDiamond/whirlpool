from utilities import checks, time, formats, userfriendlly
...
class Reminder(commands.Cog):
    ...
    # We only want the logic of reminders!
    ...
    #     else:
    #         return await ctx.send(f"Please provide a time... here is your args too ```{when.arg}```")
